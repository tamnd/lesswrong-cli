...
Most of these come down to network reality or how lesswrong serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

lesswrong rate-limits like any public site. lw already paces
...
Where a surface is gated, lw reads a cookie or token you supply
...
`lw`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what lw actually did
